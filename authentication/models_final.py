...
class Organization(models.Model):
    ...
    Your system uses accounts.id as: account_id, org_id, tenant_id
    """
    ...
    @property
    def org_id(self):
        """Alias for compatibility - org_id is same as account id"""
        return self.id
    
    @property
    def tenant_id(self):
        """Alias for compatibility - tenant_id is same as account id"""
        return self.id
    
    @property
    def account_id(self):
        """Alias for compatibility - account_id is the id"""
        return self.id
